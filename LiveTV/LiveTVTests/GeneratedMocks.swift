// MARK: - Mocks generated from file: LiveTV/Scenes/LiveChannelsList/LiveChannelsService.swift at 2017-03-07 12:10:46 +0000
...
class ListChannelsServiceProtocolStub: ListChannelsServiceProtocol {
    ...
    func getLiveChannelsList(success _: @escaping ([LiveChannel]) -> Void, failure _: @escaping (Error) -> Void) {
...
class LiveChannelsServiceStub: LiveChannelsService {
    ...
    override func getLiveChannelsList(success _: @escaping ([LiveChannel]) -> Void, failure _: @escaping (Error) -> Void) {
        return DefaultValueRegistry.defaultValue(for: Void.self)
    }
}
